...
public class AirlineManagementSystemSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http)throws Exception {
		...
		.and()
		.authorizeRequests()
		.antMatchers("/flightregister").hasRole("ROLE_ADMIN")
		.and()
		.authorizeRequests()
		.antMatchers("/updateFlight").hasRole("ROLE_ADMIN")
		.and()
		.authorizeRequests()
		.antMatchers("/updateUser").hasRole("ROLE_ADMIN")
		.and()
		.authorizeRequests()
		.antMatchers("/getAllUsers").hasRole("ROLE_ADMIN")
		.and()
		.authorizeRequests()
		.antMatchers("/deleteFlight").hasRole("ROLE_ADMIN")
		.and()
		.authorizeRequests()
		.antMatchers("/getuser").hasRole("ROLE_ADMIN")
		.and()
		.authorizeRequests()
		.antMatchers("/getAllFlights").hasRole("ROLE_ADMIN")
		.and()
		.authorizeRequests()
		.antMatchers("/TicketBooking").hasRole("ROLE_USER")
		.and()
		.authorizeRequests()
		.antMatchers("/getTicket").hasRole("ROLE_USER")
		.and()
		.authorizeRequests()
		.antMatchers("/CancelTicket").hasRole("ROLE_USER")
		.and()
